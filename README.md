...
1. Start with a blank canvas of pixels. 
    How to make blank canvas of pixels?
1. Select a brush color from a palette of colors. 
    How to make palette of colors? 
    How to select color from palette?
1. Paint the pixels on the canvas using the brush color.
    How to paint pixels on canvas?
        How to create event listener to click and place color on canvas
1. Repeat step 2.
    How to select another color from palette?
